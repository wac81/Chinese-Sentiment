...
posdict = tp.get_txt_data("./sentiment dictionary/positive and negative dictionary/posdict.txt","lines")
negdict = tp.get_txt_data("./sentiment dictionary/positive and negative dictionary//negdict.txt","lines")

# Load adverbs of degree dictionary
mostdict = tp.get_txt_data('./sentiment dictionary/adverbs of degree dictionary/most.txt', 'lines')
verydict = tp.get_txt_data('./sentiment dictionary/adverbs of degree dictionary/very.txt', 'lines')
moredict = tp.get_txt_data('./sentiment dictionary/adverbs of degree dictionary/more.txt', 'lines')
ishdict = tp.get_txt_data('./sentiment dictionary/adverbs of degree dictionary/ish.txt', 'lines')
insufficientdict = tp.get_txt_data('./sentiment dictionary/adverbs of degree dictionary/insufficiently.txt', 'lines')
inversedict = tp.get_txt_data('./sentiment dictionary/adverbs of degree dictionary/inverse.txt', 'lines')
